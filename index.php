...
<html lang="es">
  ...
  <body  >
	 <img alt="full screen background image" src="img/sistema/fondos.jpg" id="full-screen-background-image" /> 
    <div class="container" align="center" style="margin-top:10%" >
	  ...
	  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-10 animated slideInDown"   >
		   <div class="row session" style="margin-top:10px; width:320px" >
				<div class="row" align="center" style="color:#999; font-weight:bold; font-size: 14px;  margin-top:20px">
					CONTROL DE ACCESO
				</div>
				<div class="row" align="center" style="font-size:2.0em; color:#337AB7; margin-top:10px; font-weight:bold" >
					<img  src="img/logos/logoiasac.png" width="250px">
				</div>
				<div class="row" align="center" style="color:#ccc;  margin-top:30px">
					<input class="form-control" type="email"  id="correo_usuario" placeholder="Introduzca su correo electrónico" style="width:70%; font-size: 12px;" required="required">
				</div>
				<div class="row" align="center" style="color:#ccc; font-size: 11px; margin-top:10px">
					<input class="form-control" type="password" id="clave_usuario" placeholder="Contraseña" style="width:70%; font-size: 12px;" required="required" >
				</div>
				<p></p>
				<div class="col-lg-12" align="center" style="color:#ccc; margin-top:20px; margin-bottom:20px">
				<button type="submit" class="btn btn-success" id="iniciar" style="width:85%">Ingresar Sesión</button>
				</div>
