					 ...
					 $estatus=array(""=>"SELECCIONE","1"=>"ACTIVO", "0"=>"INACTIVO");
					  ...
					  $dgrid->setAutoColumnsInEditMode(false);
					   ...
					   "id_modulo_padre" =>array("header"=>"MODULO", "type"=>"enum",  "source"=>$modulo_array, "view_type"=>"dropdownlist", "width"=>"210px", "req_type"=>"sy", "title"=>"", "unique"=>false, "default"=>"0"),
						...
						"tx_ruta"  =>array("header"=>"Archivo", "type"=>"file",      "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "target_path"=>"", "allow_image_updating"=>"false", "max_file_size"=>"2M"),
