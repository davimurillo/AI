...
Sistema: GESTAP
Author: Davi Murillo
Description: GESTION DE AMBIENTAL DE PROYECTOS.
Version: 1.0
Tags: seguridad, salud, ocupacional, PAVH, IPER, AMBIENTAL, PROYECTOS, GESTION
*/
$dir=""; require_once($dir.'common.php'); checkUser(); 
?>
<head>
	<meta charset="utf-8">
	<meta name="description" content="Salud, Trabajo, Ocupación, Seguridad">
	<meta name="author" content="GESTAP">
	...
	<script src="<?php echo $dir; ?>../assets/js/bootstrap.min.js"></script>
      <!-- plugins -->
      <link rel="stylesheet" type="text/css" href="<?php echo $dir; ?>../assets/css/plugins/font-awesome.min.css"/>
      <link rel="stylesheet" type="text/css" href="<?php echo $dir; ?>../assets/css/plugins/simple-line-icons.css"/>
      <link rel="stylesheet" type="text/css" href="<?php echo $dir; ?>../assets/css/plugins/animate.min.css"/>
	<!-- end: Css -->
	<link rel="shortcut icon" href="<?php echo $dir; ?>../img/logos/logo.png">
  </head>
 <body id="mimin" class="dashboard">
      <!-- start: Header -->
		<?php require($dir."cabecera.php"); ?>
	  <!-- end: Header -->
    <div class="container-fluid mimin-wrapper">
           <!-- start:Left Menu -->
		   <?php require($dir."menu_izquierdo.php"); ?>
		    <!-- end:Left Menu -->
          <!-- start: content -->
        <div id="content">
            ...
            <div class="col-md-12" style="padding:20px;">
                 <div class="col_lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					##  *** put a primary key on the first place 
						$sql="SELECT a.id_modulo,a.tx_modulo, a.tx_ruta, a.n_orden, a.tx_icono, a.tx_icono  as icon_modulo FROM cfg_modulo a WHERE a.id_modulo_padre=0 ";
					##  *** set needed options
					  $debug_mode = false;
					  $messaging = true;
					  $unique_prefix = "f_";  
					...
					##  *** set columns in view mode
					  ...
					  $dgrid->SetViewModeTableProperties($vm_table_properties); 
						$vm_colimns = array(
						"id_modulo"  =>array("header"=>"ID","header_align"=>"center","type"=>"label", "width"=>"5%", "align"=>"center",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
						"tx_modulo"  =>array("header"=>"MODULO","header_align"=>"center","type"=>"label", "width"=>"85%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
					...
					##  ***  set settings for edit/details mode
					 ...
					 $estatus=array(""=>"SELECCIONE","1"=>"ACTIVO", "0"=>"INACTIVO");
					  ...
					  $dgrid->setAutoColumnsInEditMode(false);
					   $em_columns = array(
					   "id_modulo_padre" =>array("header"=>"MODULO", "type"=>"hidden", "view_type"=>"dropdownlist", "width"=>"210px", "req_type"=>"sy", "title"=>"", "unique"=>false, "default"=>"0"),
